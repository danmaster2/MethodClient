...
public class PlaceBlock extends Block {
    ...
    public PlaceBlock() {
        super("PlaceBlock", MainBlockType.Default, Tabs.Utils, BlockObjects.Name, BlockObjects.Words, BlockObjects.NumericalTextEnter,
        ...
        this.description = "Places a block at the given position";
    }

    @Override
    public void runCode(DragableBlock dragableBlock, Object event) {
        BlockUtils.placeBlock((BlockPos) dragableBlock.local.codeExecuter.solveObject(dragableBlock, 0, event),
