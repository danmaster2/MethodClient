...
public class CFont {
    ...
    public static void setupfont() {
        ...
        ifontRenderer26 = new CFontRenderer(new Font("Impact", Font.PLAIN, 26), true, false);
        tfontRenderer26 = new CFontRenderer(new Font("Times New Roman", Font.PLAIN, 26), true, false);
        afontRenderer26 = new CFontRenderer(new Font("Arial", Font.PLAIN, 26), true, false);
    }

    public void setFontS(String Name, double size, CFontRenderer font) {
        font.setFont(new Font(Name, Font.PLAIN, (int) size));
    }
