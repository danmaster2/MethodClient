...
public class SerializableGuiTextField extends SerializableGui implements Serializable {
    ...
    public transient GuiPageButtonList.GuiResponder guiResponder;
    public Predicate<String> validator = Predicates.<String>alwaysTrue();

    public SerializableGuiTextField(int componentId, int x, int y, int par5Width, int par6Height) {
        this.id = componentId;
        this.x = x;
        this.y = y;
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            ...
            if (!s.isEmpty()) {
                ...
                j1 = Minecraft.getMinecraft().fontRenderer.drawStringWithShadow(s1, (float) l, (float) i1, i);
            }
            ...
            if (!s.isEmpty() && flag && j < s.length()) {
                j1 = Minecraft.getMinecraft().fontRenderer.drawStringWithShadow(s.substring(j), (float) j1, (float) i1, i);
            }
            ...
            if (flag1) {
                if (flag2) {
                    ...
                    Minecraft.getMinecraft().fontRenderer.drawStringWithShadow("_", (float) k1, (float) i1, i);
                }
            }
    ...
    public void setSelectionPos(int position) {
        ...
        if (Minecraft.getMinecraft().fontRenderer != null) {
            ...
            int j = this.getWidth();
            String s = Minecraft.getMinecraft().fontRenderer.trimStringToWidth(this.text.substring(this.lineScrollOffset), j);
            int k = s.length() + this.lineScrollOffset;

            if (position == this.lineScrollOffset) {
                this.lineScrollOffset -= Minecraft.getMinecraft().fontRenderer.trimStringToWidth(this.text, j, true).length();
            }
